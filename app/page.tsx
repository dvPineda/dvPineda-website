...
const DashboardPage = () => {
  return (
    <div className="h-full bg-[#b8bfce] overflow-auto">
      <div
        className="h-screen 
                      w-full 
      ...
      >
        <header>
          <div className="w-full glass-mirror rounded-md">
            <h1 className="text-sm md:text-xl lg:text-3xl">Hello Header</h1>
          </div>
        </header>
        ...
        <main>
          <div>
            ...
            <div className="m-10 px-2 py-3 text-4xl rounded-md shadow-neon glass-mirror">
              <TypewriterComponent
                options={{
                  strings: ["Data Scientist", "AI Researcher", "Dev", "Geek"],
                  autoStart: true,
                  loop: true,
                }}
              />
        ...
        <div className="flex items-end w-full">
          <footer className="w-full text-gray-700body-font">
